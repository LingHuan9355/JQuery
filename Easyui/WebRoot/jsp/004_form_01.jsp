...
<html>
	<head>
		...
		<title>My JSP '004_form_01.jsp' starting page</title>
	...
	<body>
		...
		<div id="mydiv" class="easyui-panel"
			style="width: 400px; height: 350px" title="用户新增" align="center">
			<form action="" method="post">
				<table>
					...
					<tr>
						...
						<td>
							<input name="city" class="easyui-combobox"
								url="UserServlet?method=getCity" valueField="id"
